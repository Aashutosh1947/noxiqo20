...
export default function TeamMember() {
  ...
  return (
    <section id="team-member" className="relative py-28 z-20 overflow-hidden bg-[#070B12] border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <motion.div
            ...
            className="flex flex-col justify-center gap-6 lg:col-span-7 order-last lg:order-first"
          >
            {/* Label */}
            ...
            <p className="text-sm md:text-base text-gray-text leading-relaxed max-w-xl font-sans">
              3+ years of experience building high-performance Shopify stores. Specializes in custom Liquid development, scalable storefront architecture, performance optimization, and conversion-focused eCommerce experiences that help brands grow faster.
            </p>
          ...
          {/* Portrait Column (Right Side on Desktop, First on Mobile) */}
          <motion.div
            variants={itemVariants}
            className="relative flex items-center justify-center lg:col-span-5 order-first lg:order-last"
          >
            {/* Soft Blue Glow behind the image */}
            <div className="absolute inset-0 w-[85%] h-[85%] rounded-full bg-[#3B82F6]/10 blur-[70px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
            ...
            <div className="relative group overflow-hidden rounded-[16px] border border-white/10 shadow-2xl w-full max-w-sm sm:max-w-md lg:max-w-full">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#070B12]/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
            </div>
          </motion.div>
        </motion.div>
      </div>

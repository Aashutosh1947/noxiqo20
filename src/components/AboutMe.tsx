...
export default function AboutMe() {
  ...
  return (
    <section id="about" className="relative py-28 z-20 overflow-hidden bg-[#0B1120] border-t border-white/5">
      {/* Background soft grids inside section */}
        ...
        >
          ...
          >
            ...
            <p className="text-sm md:text-base text-gray-text leading-relaxed max-w-xl font-sans">
              MERN Stack, Next.js &amp; WordPress specialist. Bridges design and engineering to build scalable platforms powered by AI.
            </p>
